        ...
        <div class="mb-4 p-4 bg-indigo-50/50 rounded-xl border border-indigo-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="variant_sizes" value="{{ old('variant_sizes') }}" class="input-field" placeholder="S, M, L, XL">
                </div>
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-700">Colors</label>
                    <input type="text" name="variant_colors" value="{{ old('variant_colors') }}" class="input-field" placeholder="Red, Blue, Green">
                </div>
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-700">Materials</label>
                    <input type="text" name="variant_materials" value="{{ old('variant_materials') }}" class="input-field" placeholder="Cotton, Wool">
                </div>
            </div>
        </div>
        <div class="mb-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title') }}" class="input-field" placeholder="SEO title (leave blank to use product name)" maxlength="255">
                </div>
                <div>
                    <label class="block mb-1 text-sm font-medium text-gray-700">Meta Description</label>
                    <textarea name="meta_description" rows="2" class="input-field" placeholder="Short description for search engines" maxlength="500">{{ old('meta_description') }}</textarea>
                </div>
                <div>
                    <label class="block mb-1 text-sm font-medium text-gray-700">Meta Keywords</label>
                    <input type="text" name="meta_keywords" value="{{ old('meta_keywords') }}" class="input-field" placeholder="keyword1, keyword2, keyword3" maxlength="255">
                </div>
            </div>
        </div>
        <div class="mb-4">
