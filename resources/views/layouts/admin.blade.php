...
<body class="antialiased bg-gray-50">
    <div class="flex min-h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-gray-900 text-white flex flex-shrink-0 flex-col h-screen transform -translate-x-full transition-transform duration-300 ease-in-out">
            ...
            <nav class="flex-1 py-4 px-3 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('admin.payments.index') }}" class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg {{ request()->routeIs('admin.payments.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.backup-restore') }}" class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg {{ request()->routeIs('admin.backup-restore*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.payment-methods.index') }}" class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg {{ request()->routeIs('admin.payment-methods.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 11c0 3-2 5-2 5s-2-2-2-5a2 2 0 114 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 2v1m0 18v1M4.93 4.93l.7.7m14.14-.7l-.7.7M2 12h1m18 0h1M6 18l.7-.7M18 18l-.7-.7"/></svg>
                    Payment Methods
                </a>
                ...
                <a href="{{ route('admin.coupons.index') }}" class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg {{ request()->routeIs('admin.coupons.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h12m0 0l-4-4m4 4l-4 4M3 5h4M3 7h4M3 19h4M3 21h4m4-14h10M3 12h18M3 15h18"/></svg>
                    Coupons
                </a>
                <a href="{{ route('admin.shipping.index') }}" class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg {{ request()->routeIs('admin.shipping.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/></svg>
                    Shipping
                </a>
                <a href="{{ route('admin.tax.index') }}" class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-lg {{ request()->routeIs('admin.tax.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m-6 4h6m-6 4h4M5 4h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1z"/></svg>
                    Tax Rates
                </a>
